    ...
    return(
        ...
        <div className='istelevision'>
            ...
            <div className="te-event">
                ...
                <img src={music}/>
                    <h3>Music Shows</h3>
                    <p>Apex Event Design specializes in crafting sophisticated and unforgettable decorations for your Music Shows. We bring recognition and celebration to life with elegant themes, stunning centerpieces, and tailored details.
                    </p>
                </div>
            </div>
